# -*- encoding: utf-8 -*-
# stub: jekyll-remote-theme 0.5.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<jekyll-sass-converter>.freeze, [">= 1.0", "< 4.0", "!= 2.0.0"])
  s.add_runtime_dependency(%q<openssl>.freeze, [">= 3.1.2"])
  s.add_runtime_dependency(%q<rubyzip>.freeze, [">= 1.3.0", "< 4.0"])
  ...
  s.add_development_dependency(%q<rubocop>.freeze, ["~> 1.57"])
  s.add_development_dependency(%q<rubocop-jekyll>.freeze, ["~> 0.14"])
