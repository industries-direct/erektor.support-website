...
<section class="wrap pt-1" >
  ...
  <h1>Every leg comes home. Tell us what to do with it.</h1>
  <p class="lede">Field crews need one decision, not a maze of options: fix it on the floor, flag it for
  ERS, or dispatch a replacement leg.</p>
</section>
...
<section class="wrap mt-2" aria-labelledby="routes-title">
  <div class="sec-head">
    <span class="eyebrow eyebrow--plain">Or pick the route yourself</span>
    <h2 id="routes-title">Can the leg finish this session?</h2>
  </div>
  <div class="grid grid--3">
    <a class="card card--urgent" href="dispatch.html">
      <span class="card__answer">No</span>
      <h3>Request a replacement leg</h3>
      <p>We send a healthy leg from the pool and the failed one rides back to check-in with the driver.</p>
      <div class="card__meta">Emergency &middot; 24/7</div>
    </a>
    <a class="card card--plan" href="maintenance.html">
      <span class="card__answer">Yes, but it needs work</span>
      <h3>Flag a leg for ERS</h3>
      <p>No truck &mdash; the flag rides on the leg&rsquo;s record and ERS diverts it at inspection when it
      returns.</p>
      <div class="card__meta">Planned &middot; no site visit</div>
    </a>
    <a class="card card--docs" href="docs/faults.html">
      <span class="card__answer">Yes, and you can clear it</span>
      <h3>Fix it on the floor</h3>
      <p>Operator-serviceable faults carry their own procedure. No ticket, and nothing changes on the
      leg&rsquo;s record.</p>
      <div class="card__meta">Fault code index</div>
    </a>
  </div>
</section>
...
<div class="specstrip band-gap" >
  <div class="wrap specstrip-in">
    ...
    <div class="spec"><div class="n">2<small>&nbsp;serials</small></div><div class="k">Electronics &amp; mechanical</div></div>
...
<section class="wrap mt-5" >
  ...
  <div class="grid grid--3">
    <a class="card card--docs" href="docs/">
      ...
      <div class="card__meta">Documentation</div>
    </a>
