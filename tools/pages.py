...
<section class="wrap mt-4"  data-triage>
  <div class="sec-head">
    <span class="eyebrow">Start here</span>
    <h2>Look up the code on the controller.</h2>
    <p>Type a fault code or a few words. The table decides which route you are on and carries the code
    into the right form.</p>
  </div>
  <div class="field limit-input" >
    ...
    <p class="field__hint">Codes read <code>SUB-nn</code> &mdash; for example <code>DRV-40</code> or <code>NET-20</code>.</p>
  </div>
